...
contract ConsignorLogic is ConsignorLayout, Delegate {
    ...
    function testFunction(address _a, bytes32 _b, uint256 _c, uint256[] calldata _d) external view
    ...
    function testFunction2(address _a, bytes32 _b, uint256 _c, uint256[] calldata _d) external view
